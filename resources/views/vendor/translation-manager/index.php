...
<div class="container-fluid">
    ...
    <div class="alert alert-success success-publish" style="display:none;">
        <p><?php echo __('Done publishing the translations for group :group!', ['group' => e($group)]); ?></p>
    </div>
    ...
    <?php endif; ?>
    <?php if(isset($group)) : ?>
        <form class="form-inline form-publish" method="POST" action="<?php echo action('\Barryvdh\TranslationManager\Controller@postPublish', $group) ?>" data-remote="true" role="form" data-confirm="<?php echo __('Are you sure you want to publish the translations group :group? This will overwrite existing language files.', ['group' => e($group)]); ?>">
            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                    ...
                    <?php if ($deleteEnabled): ?>
                        <td>
                            <a href="<?php echo action('\Barryvdh\TranslationManager\Controller@postDelete', [$group, $key]) ?>"
                               class="delete-key"
                               data-confirm="<?php echo __('Are you sure you want to delete the translations for :key?', ['key' => e($key)]); ?><span
